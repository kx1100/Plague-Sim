...
TRAITS = {
    ...
    # ══════════════════════════════════════════════════════════════════
    # SYMPTOM TREE
    # Chain: Nausea → Vomiting → Diarrhoea → Dysentery
    ...
    #          Sweating + Cysts → ImmuneSuppression
    #        Anaemia → Haemophilia → InternalHaemorrhaging → HaemorrhagicShock
    #        ImmuneSuppression + Anaemia → Paralysis
    # ══════════════════════════════════════════════════════════════════
    ...
    "Paralysis": {
        ...
        "tree": "symptom",
        "cost": 10,
        "prereqs": ["ImmuneSuppression", "Anaemia"],
...
def get_available_traits(evolved: set) -> dict:
...
def get_affordable_traits(evolved: set, dna: int) -> dict:
    ...
    available = get_available_traits(evolved)
